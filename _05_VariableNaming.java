...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        //6. 예약어 사용 불가 (Public, static, void, int, double, flat, ....)

        // 다른 나라 입국 신고서(여행)
        String nationality="대한민국"; // 국적
        String firstName = "현성"; // 이름
        String lastName = "김"; // 성
        String dateOfBirth = "1998-03-26"; //생년월일
        String residentialAddress = "Hotel"; //체류지
        String purposeOfVisit="관광";//입국목적
        String flightNo = "KE657";//항공 편명
        String _flightNo = "KE657";// 밑줄 시작
        String flight_no_2 = "KE657";//밑줄과 숫자 포함
        // String -flightNo = "KE657" //-사용 불가
        ...
        String item1 = "시계";
        String item2 = "가방";
        //String 3itme = "전자제품"; //숫자가 앞에 먼저 나오면 x
