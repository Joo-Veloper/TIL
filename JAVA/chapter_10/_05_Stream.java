...
//        System.out.println(langList.size());
        ...
        //최종 연산 (Terminal Operation) : count, min, max, sum, forEach
...
//        Arrays.stream(scores).filter(x -> x >= 90).forEach(System.out::println);
        ...
        // 4글자 이하의 언어 중에서 c 라는 글자를 포함한느 언어 뒤에 (어려워요) 라는 글자 출력
        // map
